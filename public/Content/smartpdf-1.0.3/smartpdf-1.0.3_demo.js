...
(function (root, factory) {
    ...
    var pdfWorkingArea = '<div id="dpi" style="height: 1in; left: -100%; position: absolute; top: -100%; width: 1in;"></div>' +
        ...
        // ' <div class="dropdown-divider"></div>' +
        // ' <a class="dropdown-item" href="#">Request signatures from others...</a> ' +
        // ' <div class="dropdown-divider"></div>' +
   ...
   /*
    var pdfWorkingArea = '<div id="dpi" style="height: 1in; left: 100%; position: absolute; top: 100%; width: 1in;"></div>' +
        ...
        ' </button> ' +
        ' <div class="dropdown-menu"> ' +
        ' <a class="dropdown-item" href="javascript:void(0)" onclick="PDFCreateSignature(event)" data-noactive="true" data-btn-function="AddSignature">Create your signature...</a>' +
        ' <a class="dropdown-item" href="#" id="sigUserName">Signer: </a> ' +
        ' </div>' +
        ' </div>' +
