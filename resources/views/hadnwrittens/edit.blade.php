...
<div class="page-content">
    <form action="{{ route('hadnwrittens.update', $handwritten->id) }}" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
    @csrf
    @method('put')
        <!-- Primer Panel -->
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">Firma de: {{ Auth::user()->name }} <br>
                    <small>Actualizar manuscrito digitalizado {{ $handwritten->path }}</small><br>
                </h3>
            </div>
            <div class="panel-body container-fluid">

                <h4 class="example-title">Digitaliza tu nueva firma</h4>
                <div class="example">
                    ...
                    <button type='submit' class="btn btn-success" onclick='GuardarTrazado()'>Actualizar firma</button>
