<nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega navbar-inverse" role="navigation">
    ...
    <div class="navbar-header">
        ...
        <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
            <img class="navbar-brand-logo" src="{{ asset('backend/img/brand.png') }}" title="Filex">
            <span class="navbar-brand-text hidden-xs-down"> Filex</span>
        </div>
    ...
    <!-- Navbar Collapse -->
        <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
                    ...
                    <div class="mega-content">
                        ...
                        <div class="col-md-4">
                            ...
                            <li>
                                ...
                                <img class="w-full" src="{{ asset('backend/global/photos/placeholder.png') }}" alt="..." />
                                </a>
                            </li>
                            <li>
                                <a class="thumbnail m-0" href="javascript:void(0)">
                ...
                <li class="nav-item dropdown">
                    ...
                    data-animation="scale-up" role="button">
                        <span class="avatar avatar-online">
                            <img src="{{ asset('backend/img/brand.png') }}" alt="...">
                            <i></i>
                        </span>
                    </a>
                    <div class="dropdown-menu" role="menu">
                        <a class="dropdown-item" href="javascript:void(0)" role="menuitem"><i class="icon md-account" aria-hidden="true"></i> Perfil</a>
                        <a class="dropdown-item" href="javascript:void(0)" role="menuitem"><i class="icon md-card" aria-hidden="true"></i> Métodos de pago</a>
                        <a class="dropdown-item" href="javascript:void(0)" role="menuitem"><i class="icon md-settings" aria-hidden="true"></i> Configuración</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ route('logout') }}" role="menuitem" onclick="event.preventDefault();
                        document.getElementById('logout-form').submit();"><i class="icon md-power" aria-hidden="true"></i> Logout</a>
            ...
            <a href="{{ route('home') }}">
                <img class="navbar-brand-logo navbar-brand-logo-normal" src="{{ asset('backend/img/brand.png') }}"
                title="Filex">
                <img class="navbar-brand-logo navbar-brand-logo-special" src="{{ asset('backend/img/brand.png') }}"
                title="Filex">
            </a>
            </div>
        </div>
