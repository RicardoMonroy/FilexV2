<div class="site-menubar">
    <div class="site-menubar-header">
        <div class="cover overlay">
            <img class="cover-image" src="{{ asset('backend/img/dashboard-header.png') }}"
            alt="...">
            ...
            <div>
                <ul class="site-menu" data-plugin="menu">
                    <li class="site-menu-item">
                        <a class="animsition-link" href="{{ route('home') }}" class="{{ $activePage == 'dashboard' ? ' active' : '' }}">
                            <i class="site-menu-icon md-view-dashboard" aria-hidden="true"></i>
                            <span class="site-menu-title">Dashboard</span>
                        </a>
                    </li>
                    <li class="site-menu-item">
                        <a class="animsition-link" href="{{ route('contracts.index') }}" class="{{ $activePage == 'contracts' ? ' active' : '' }}">
                            <i class="site-menu-icon md-file-text" aria-hidden="true"></i>
                            <span class="site-menu-title">Mis Contratos</span>
                        </a>
                    </li>
                    <li class="site-menu-item has-sub open
                        ...
                        <a href="javascript:void(0)">
                            ...
                            <span class="site-menu-title">Landinpage</span>
                                    <span class="site-menu-arrow"></span>
                        </a>
                        <ul class="site-menu-sub">
                            <li class="site-menu-item">
                                <a class="animsition-link" href="{{ route('sliders.index') }}" class="{{ $activePage == 'sliders' ? ' active' : '' }}">
